...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen):
        ...
        self.label_title.setStyleSheet(u"color: rgb(23, 234, 217);")
        ...
        self.progressBar.setStyleSheet(u"QProgressBar {\n"
                                       ...
                                       "QProgressBar::chunk{\n"
                                       "	border-radius: 10px;\n"
                                       "	background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(23, 234, 217,255), stop:1 rgba(143,211,244, 255));\n"
                                       "}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>The</strong> Ultimate</strong> Coding</strong> Tool", None))
        self.label_description.setText(
            QCoreApplication.translate("SplashScreen", u"<strong>APP</strong> DESCRIPTION", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.label_credits.setText(
            QCoreApplication.translate("SplashScreen", u"<strong>Created by</strong>: Hadas and Ido Abraham", None))
    # retranslateUi
