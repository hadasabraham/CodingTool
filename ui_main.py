...
#if QT_CONFIG(tooltip)
        self.infosvtc.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Algorithm implemented by : Guy Shapira and maxim barsky</p><p>Algorithm invented by : <span style=\" font-family:'Calibri';\">Clayton Schoeny, Antonia Wachter-Zeh, Ryan Gabrys, Eitan Yaakobi</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
